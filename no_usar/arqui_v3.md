...
| B | is_example | Dropdown TRUE/FALSE, persistido en DB para marcar filas ejemplo |
...
**Flujo:** SheetJS parsea en browser → persiste `is_example` → validar scope de `question_id` → validar campos → bulk INSERT en lotes de 100.

**Reglas de idempotencia:**
- `is_example = TRUE` → se puede importar, pero nunca entra al pool jugable ni al catálogo normal
